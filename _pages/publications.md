...
>*This paper examines the drivers behind the French residential electricity consumption reduction that started during the 2022-2023 energy crisis. Using an Autoregressive Distributed Lag (ARDL) model, the analysis quantifies the effects of retail price increases, political statements, and weather conditions on household consumption. The results show that price shocks explain a 6 TWh reduction, while political statements referring to the energy crisis contributed an additional 2 TWh. In contrast, general conservation messages promoting energy-saving tips had no significant impact. Mild winter temperatures accounted for another 2.4 TWh reduction.
The analysis reveals that households with off-peak tariffs were more responsive to both price changes and crisis narratives, with effects persisting over time. In contrast, base tariff households showed limited adjustment. These findings underline the importance of repeated crisis communication and price signals to sustain energy savings and highlight that generic conservation campaigns, when not framed within a crisis context, appear insufficient to change behavior at scale.*
